...
public object Peace {
    ...
    public val requestTimers: HashMap<PeaceRequestInstance, ScheduledTask> = hashMapOf()
    ...
    public fun request(town1: Town, town2: Town): Result<PeaceRequest> {
        ...
        // add peace request
            ...
            val timeoutThread = Bukkit.getAsyncScheduler().runDelayed(Nodes.plugin!!, {
                Peace.cancelRequest(peaceRequest) }, PEACE_REQUEST_TIMEOUT * 50, TimeUnit.MILLISECONDS)
